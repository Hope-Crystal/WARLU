                                ...
                                <li class="bets__item position-relative">
                                    ...
                                    <div class="bets__item-content">
                                        ...
                                        <p class="text-info">{{trans('Invoice ID')}} : <span
                                                class="text-dark">{{$item['invoice']}}</span></p>
    ...
    @push('loadModal')
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content form-block">
                    <div class="modal-header">
                        ...
                        <img src="{{getFile(config('location.logoIcon.path').'logo.png')}}" alt="logo" style="width: 90px; z-index:999;">
                    ...
                    <div class="modal-body">
                        ...
                        <p><span class="text--base">{{trans('Description')}} : </span> <span class="escrow-rules"></span></p>
                        <p class="show-file"></p>

                        <p><span class="text--base pt-2">{{trans('Transaction Partner Fullname')}} : </span> <span
                                class="invitor-fullname"></span></p>
                        <p><span class="text--base">{{trans('Transaction Partner Email')}} : </span> <span
                                class="invitor-email"></span></p>
                        <p><span class="text--base">{{trans('Transaction Partner Username')}} : </span> <span
        ...
        <div class="card" style="background-color: #fff;">
								<div class="card-body m-sm-3 m-md-5">
									<div class="mb-4">
										Hello <strong><?php echo "$user->username" ?></strong>,
										<br /> This is the invoice for a Transaction of <strong class="escrow-amount"></strong> to <span
		class="invitor-username"></span
									</div>

									<div class="row">
										<div class="col-md-6">
											<div class="text-muted">Invoice No.</div>
											<strong> <span class="escrow-invoice"></span></strong>
										</div>
										<div class="col-md-6 text-md-right">
											<div class="text-muted">Invivited Date</div>
											<strong><span class="invited-at"></span></strong>
										</div>
                                        <div class="col-md-6 text-md-right">
											<div class="text-muted">Escrow Charges</div>
											<strong><span class="charge_bear"></span></strong>
										</div>
                                        <div class="col-md-6 text-md-right">
											<div class="text-muted show-file"></div>
										</div>
									</div>
									...
									<div class="row mb-4">
										<div class="col-md-6">
											<div class="text-muted"> <strong> From:  </strong></div>
											<br> 
                                            <span>Username:</span>   <p class="invitee_username"><?php echo "$user->username" ?> </p>
                                            <span>Fullname:</span> <p class="invitee_fullname"> <?php echo "$user->fullname" ?>	 </p>
                                            <span>Email:</span><p class="invitee_email"> <?php echo "$user->email" ?></p>
                                            <p class="invitee_fullname"></p>
										</div>
                                        <hr class="my-4" />
										<div class="col-md-6 text-md-right">
											<div class="text-muted"> <strong> To: <strong> </div>
                                            <br>
       <span>Username:</span> <p class="invitor-username"></p>
       <span>Fullname:</span> <p class="invitor-fullname"></p>
       <span>Email:</span> <p class="invitor-email"></p>
										</div>
									</div>
									...
									<table class="table table-sm">
										...
										<tbody>
											<tr>
												<td><strong><span class="escrow-rules"></span></strong></td>
												<td class="text-right" ><span class="escrow-amount"></span></td>
											</tr>
											<tr>
												<td>Escrow Charges Amount </td>
										
												<td class="text-right"><span class="charge"></span></td>
											</tr>
...
<!-- 									
											<tr>
												...
												<th class="text-right"> <span class="escrow-amount"></span></th>
											</tr> -->
                                            </tbody>
									</table>
									...
									<div class="text-center">
										<p class="text-sm">
											Extra note: You are only charged for Escrow services after a complete transaction. Thanks for using Warlu !
										</p>
                ...
                <div class="modal-content form-block">
                    ...
                    <form action="" method="post" class="escrowConfirmation">
                        ...
                        <div class="modal-body">
                            ...
                            <p><span class="text--base">{{trans('Description')}} : </span> <span class="escrow-rules"></span>
                            </p>


                            <p class="show-file" style="color:#1f2235;"></p>
    ...
    <script>
        ...
        $('.seeDetails').on('click', function () {
            ...
            if(image == ''){
                ...
                $('.show-file').html(`<span class="text--base">{{trans('Documents')}} : </span> <a href="${file_location}" class="text-dark">${image}</a>`)
            }
