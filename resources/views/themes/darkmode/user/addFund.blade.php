...
@section('content')
    ...
    @push('loadModal')
    <div id="wrapper">
        <div id="addFundModal" class="modal fade addFundModal content-wrapper" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content form-block">
                    <div class="modal-header">
                    <br>
                        <h6 class="modal-title method-name" style="font-size: 18px; margin-top:60px;"></h6>
                        <img src="{{getFile(config('location.logoIcon.path').'logo.png')}}" alt="logo" style="width: 90px; z-index:999; margin-top:-55px;">
