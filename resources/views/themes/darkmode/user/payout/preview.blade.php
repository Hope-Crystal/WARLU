...
@section('content')
    ...
    <div id="wrapper">
    <section class="privacy pt-100 pb-100 section--bg overflow-hidden secbg content-wrapper">
        <div class="container">
                                ...
                                @if(optional($withdraw->method)->input_form)
                                    @foreach($withdraw->method->input_form as $k => $v)
                                        ...
                                        @elseif($v->type == "textarea")
                                            <div class="col-md-12 mt-2">
                                                <div class="form-group">
                                                    <label>{{trans($v->field_level)}} @if($v->validation == 'required') @lang('Account Number') <span class="text--danger">*</span>  @endif </label>
